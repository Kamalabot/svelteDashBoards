...
<div class="pa2 blue">
    <h3 class="black">The Challenge</h3>
    <p class="lh-copy f3">
        Ideas of abstracting complete chart is not new. There is <a href="https://vega.github.io/">Vega</a> and <a href="https://github.com/observablehq/plot">Plot</a>  written by D3 
...
<div class="flex">
	...
	<ScatterChart width={400} height={300} chartData={data.chartData[0].data} xVar={data.xVar} yVar={data.yVar} color={data.color} label={data.title}/>
	</div>
	<div class="tc">
	<h3 class="black">Histogram Chart</h3>
	<Histogram width={400} height={300} chartData={data.chartData[0].data} Var={data.yVar} Bins={10} color={data.color} label={'Histogram of Cases'}/>
	</div>
</div>
<div class="pa2 blue">
    ...
    <pre> &lt;LineChart height width chartData /&gt;</pre>
	<div class="tc">
		<h3 class="black">Viz1 Histogram & Scatterplot</h3>	
		<HistoScatter width={700} height={500} chartData={data.chartData[0].data} Var={data.yVar} refVar={data.xVar} Bins={10} histoColor={data.color} scatterColor={'blue'}/>
	</div>
    <p class="lh-copy f3">
        What is Scatterplot? It is plot showing change of one variable with respect to a reference. So it must have  Xvariable, YVariable. The styles and attributes play a vital role in controlling the visualisation. Grammar of Graphics implemented in Vega is a wonderful example. 
